                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?= $this->session->userdata('fullname') ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?= $this->session->userdata('role') ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?= $this->session->userdata('fullname') ?>!</h6>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                         ...
                         <!-- logout -->
                         <li class="nav-item">
                            <a href="<?= base_url('logout') ?>" class="nav-link menu-link "><i class="ri-dashboard-2-line"></i><span data-key="t-dashboard">logout</span>
                            </a>
                        </li> 
                    </ul>
                </div>
